"use strict";
(self["webpackChunkeDoc"] = self["webpackChunkeDoc"] || []).push([["default-node_modules_angular_material_fesm2020_core_mjs"],{
...
class ListKeyManager {
  ...
  destroy() {
    var _this$_itemChangesSub;
    this._typeaheadSubscription.unsubscribe();
    (_this$_itemChangesSub = this._itemChangesSubscription) === null || _this$_itemChangesSub === void 0 ? void 0 : _this$_itemChangesSub.unsubscribe();
...
class FocusMonitor {
  ...
  _shouldBeAttributedToTouch(focusEventTarget) {
    ...
    return this._detectionMode === 1 /* FocusMonitorDetectionMode.EVENTUAL */ || !!(focusEventTarget !== null && focusEventTarget !== void 0 && focusEventTarget.contains(this._inputModalityDetector._mostRecentTarget));
  }
  /**
...
const VERSION = new _angular_core__WEBPACK_IMPORTED_MODULE_0__.Version('15.2.8');
  ...
  constructor() {
    ...
    this._delegateEventHandler = event => {
      ...
      if (target) {
        ...
        (_this$_events$get = this._events.get(event.type)) === null || _this$_events$get === void 0 ? void 0 : _this$_events$get.forEach((handlers, element) => {
...
//# sourceMappingURL=default-node_modules_angular_material_fesm2020_core_mjs.js.map