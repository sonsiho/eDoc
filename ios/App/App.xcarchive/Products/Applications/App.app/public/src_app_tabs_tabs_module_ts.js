...
const routes = [{
  ...
  children: [{
    path: 'home',
    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_core_services_biometric_biometric_service_ts"), __webpack_require__.e("src_app_pages_secure_home_home_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ../pages/secure/home/home.module */ 6424)).then(m => m.HomePageModule)
  }, {
    path: '',
    redirectTo: 'home',
    pathMatch: 'full'
